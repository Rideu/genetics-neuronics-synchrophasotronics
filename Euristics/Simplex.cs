...
namespace Euristics
{
    ...
    public static class Simplex
    {
        ...
        public static Texture2D CutOut(Texture2D tex, Rectangle rect)
        {
            ...
            Texture2D rtex = new Texture2D(graphics, rect.Width, rect.Height);
        ...
        public static Texture2D CutOut(Texture2D tex, Rectangle source, Rectangle target)
        {
            ...
            Texture2D rtex = new Texture2D(graphics, target.Width, target.Height);
            rtex.SetData(sheetbuf);
            return rtex;
        }
        ...
        //{
        //    return Simplex.OffsettedTexture(pos.TexEqBounds, pos).Intersects(Core.GlobalDrawingBounds);
        //}
